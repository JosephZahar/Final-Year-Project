...
def cancerSpread(grid_size_n,number_cancer_cell,number_robots):
    ...
    for t in range(t1, time):
        if number_robots ==1:
            cell_states[t1, 50,2] = ROBOT1
            cell_states[t1, 60, 2] = ROBOT2
            cell_states[t1, 70, 2] = ROBOT3
            cell_states[t1, 80, 2] = ROBOT4
            cell_states[t1, 90, 2] = ROBOT5
            cell_states[t1, 40, 2] = ROBOT6
            ...
            for y in range(1, organ_size[1] - 1):
                ...
                def moving(particle):
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y + 1] == NORMAL and \
                            cell_states[t - 1, x+1, y ] == NORMAL and cell_states[t - 1, x-1, y ] == CANCER and cell_states[t - 1, x, y - 1] == NORMAL :
                        cell_states[t, x, y] = HEAL
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y + 1] == BOUNDARY and \
                            cell_states[t - 1, x+1, y ] == NORMAL and cell_states[t - 1, x-1, y ] == NORMAL and cell_states[t - 1, x, y - 1] == CANCER :
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x+1, y] = HEAL
                        cell_states[t, x-1, y] = HEAL
                        cell_states[t, x, y-1] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y + 1] == NORMAL and \
                            cell_states[t - 1, x+1, y ] == CANCER and cell_states[t - 1, x-1, y ] == NORMAL and cell_states[t - 1, x, y - 1] == CANCER :
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x, y-1] = HEAL
                        cell_states[t, x, y+1] = HEAL
                        cell_states[t, x+1, y] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y + 1] == NORMAL and \
                            cell_states[t - 1, x+1, y ] == NORMAL and cell_states[t - 1, x-1, y ] == CANCER and cell_states[t - 1, x, y - 1] == CANCER :
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x, y-1] = HEAL
                        cell_states[t, x, y+1] = HEAL
                        cell_states[t, x-1, y] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y + 1] == BOUNDARY and \
                            cell_states[t - 1, x+1, y ] == CANCER and cell_states[t - 1, x-1, y ] == CANCER and cell_states[t - 1, x, y - 1] == NORMAL :
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x+1, y] = HEAL
                        cell_states[t, x-1, y] = HEAL
                        cell_states[t, x-1, y] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y + 1] == NORMAL and \
                            cell_states[t - 1, x-1, y ] == NORMAL and cell_states[t - 1, x+1, y ] == NORMAL and cell_states[t - 1, x, y - 1] == NORMAL :
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x-1, y] = HEAL
                        cell_states[t, x+1, y] = HEAL
                        cell_states[t, x, y-1] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x-1, y] == BOUNDARY and cell_states[t - 1, x+1, y] == NORMAL:
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x+1, y] = HEAL
                        cell_states[t, x, y-1] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y + 1] == NORMAL and \
                            cell_states[t - 1, x-1, y ] == CANCER and cell_states[t - 1, x+1, y ] == CANCER and cell_states[t - 1, x, y - 1] == CANCER :
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x, y+1] = HEAL
                        cell_states[t, x, y-1] = HEAL
                        cell_states[t, x-1, y] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x+1, y ] == BLOOD and cell_states[t - 1, x, y-1 ] == NORMAL and cell_states[t - 1, x, y+1 ] == CANCER:
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x+1, y] = BLOOD
                        cell_states[t, x-1, y] = HEAL
                        cell_states[t, x, y+1] = particle

                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x+1, y ] == BLOOD and cell_states[t - 1, x, y-1 ] == CANCER:
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x+1, y] = BLOOD
                        cell_states[t, x-1, y] = HEAL
                        cell_states[t, x, y-1] = particle

                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x+1, y ] == BLOOD and cell_states[t - 1, x, y-1 ] == NORMAL \
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x-1, y ] == BLOOD and cell_states[t - 1, x, y-1 ] == NORMAL and cell_states[t - 1, x, y+1 ] == NORMAL:
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x-1, y] = BLOOD
                        cell_states[t, x+1, y] = HEAL
                        cell_states[t, x, y-1] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x+1, y] == BOUNDARY and \
                            cell_states[t - 1, x-1, y ] == CANCER and cell_states[t - 1, x, y-1 ] == NORMAL and cell_states[t - 1, x, y + 1] == CANCER :
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x-1, y] = HEAL
                        cell_states[t, x, y+1] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y+1] == BOUNDARY and \
                            {cell_states[t - 1, x, i] == CANCER for i in range(2,107)} and cell_states[t - 1, x-1, y] == NORMAL :
                            cell_states[t, x, y] = HEAL
                            cell_states[t, x - 1, y] = HEAL
                            cell_states[t, x, y - 1] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x+1, y] == BOUNDARY and cell_states[t - 1, x, y+1] == CANCER:
                            cell_states[t, x, y] = HEAL
                            cell_states[t, x-1, y] = HEAL
                            cell_states[t, x, y+1 ] = particle

                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x+1, y] == BOUNDARY and cell_states[t - 1, x-1, y] == CANCER:
                            cell_states[t, x, y] = HEAL
                            cell_states[t, x, y+1] = HEAL
                            cell_states[t, x-1, y ] = particle
                    ...
                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x, y-1] == BOUNDARY and cell_states[t - 1, x, y+1] == CANCER:
                            cell_states[t, x, y] = HEAL
                            cell_states[t, x+1, y] = HEAL
                            cell_states[t, x, y+1 ] = particle

                    if cell_states[t - 1, x, y] == particle and cell_states[t - 1, x-1, y] == BOUNDARY and \
                            cell_states[t - 1, x, y + 1] == CANCER and cell_states[t - 1, x, y - 1] == CANCER and cell_states[t - 1, x+1, y] == NORMAL:
                        cell_states[t, x, y] = HEAL
                        cell_states[t, x, y+1] = HEAL
                        cell_states[t, x, y - 1] = particle
